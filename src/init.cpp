...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/scorcoin-project/scorcoin>";
    const std::string URL_WEBSITE = "<https://scorcoin.org>";
