...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s scorcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  scorcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded scorcoin transaction") + "\n" +
              "  scorcoin-tx [options] -create [commands]   " + _("Create hex-encoded scorcoin transaction") + "\n" +
              "\n";
