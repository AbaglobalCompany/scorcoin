...
const char * const BITCOIN_CONF_FILENAME = "scorcoin.conf";
const char * const BITCOIN_PID_FILENAME = "scorcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Scorcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Scorcoin";
#else
    // Unix
    return pathRet / ".scorcoin";
#endif
#endif
}
